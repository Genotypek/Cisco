...
Func WyczyscTabliceFiltrow() ; Czyszczenie tablicy filtrów
		While UBound($Array_Tablica_Filtrow) <> 0 ;	Usuwanie tablicy w pêtli dopóki nie bêdzie pusta
			_ArrayDelete($Array_Tablica_Filtrow, 0)
		WEnd
EndFunc

Func SprawdzTablicePytan() ; Sprawdzanie pytañ, które aktualnie znajduj¹ siê w tablicy
	_ArrayDisplay($Array_Tablica_Pytan, "Tablica pytañ")
EndFunc   ;==>SprawdzTablicePytan

Func DodajPytaniaDoTablicy() ; Dodawanie s³ówek do tablicy
